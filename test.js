const playTime = 3200; // Changed playtime to 32
const SCORE = 80000; // Changed score to 420
const blockCnt = 13370; // Changed block count to 1337
...
async function getAuthToken() {
    try {
        ...
        const getUUID = 'HERE IS YOUR COOKIE UUID';
...
async function setScore(SCORE, playTime, blockCnt) {
    try {
        ...
        if (!authToken) {
            throw new Error('Authentication token not obtained');
        }
